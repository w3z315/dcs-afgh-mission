--[[
    ...
    But i would appreciate some credit if you "borrow" some code ;p
...
if lfs then
    ...
    --Change to 'true' if you want to load all settings below from a .lua file (so you just need to restart mission to change a setting here)
    ...
    --!!When putting in your directory make sure you use the '/' other wise it will not find the directory

    Settings_Dir = lfs.writedir()..'Missions/Editing/weazel-afgh-mission/saves'
    ...
    --put your directory in between the "" where you have all your lua files in.
    ...
    Dir = lfs.writedir()..'Missions/Editing/weazel-afgh-mission/scripts/'
